const products = [
    { id: 1, name: 'Gulnaar Banarasi', type: 'silk', detail: 'Handwoven silk · Deep rose', price: '₹6,850', tag: 'Bestseller', image: '/images/saree-1.jpeg', description: 'An exquisite handwoven Banarasi silk saree in a deep rose shade, featuring royal floral zari work. Perfect for weddings and heirloom collections.', media: { angles: ['/images/saree-1.jpeg', '/images/detail-1.png', '/images/detail-2.png', '/images/detail-3.png'], video: '/images/saree-video.mp4' } },
